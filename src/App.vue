    ...
    <div class="container">
      ...
      <div>
        ...
        <div class="text-center mt-4">
          <a href="https://openreview.net/group?id=KDD.org/2026/Workshop/AgenticSE#tab-recent-activity" target="_blank" rel="noopener noreferrer" class="btn-register" style="font-size: 1.2rem; padding: 1rem 2.5rem;">
